...
class MercadoPagoProviderService extends AbstractPaymentProvider<MercadoPagoOptions> {
  ...
  async initiatePayment(input: InitiatePaymentInput): Promise<InitiatePaymentOutput> {
    ...
    const preferenceData: any = {
      ...
      back_urls: {
        success: this.options_.back_url_success || `${process.env.STORE_URL}/checkout/success`,
        failure: this.options_.back_url_failure || `${process.env.STORE_URL}/checkout/failure`,
        pending: this.options_.back_url_pending || `${process.env.STORE_URL}/checkout/pending`,
      },
      auto_return: "approved",
      notification_url: this.options_.notification_url || `${process.env.BACKEND_URL}/webhooks/mercadopago`,
